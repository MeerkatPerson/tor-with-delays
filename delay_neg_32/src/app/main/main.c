...
#include <stdlib.h> // 20/01 include so we can use the dumb 'rand()' function to obtain deterministic behavior
...
tor_init(int argc, char *argv[])
{
 ...
 /* give it somewhere to log to initially */
  ...
  /** 20/01 ultimate hackiness: set a seed for our dumb stdlib prng - not crypto-safe, but deterministic */
  srand(666);
