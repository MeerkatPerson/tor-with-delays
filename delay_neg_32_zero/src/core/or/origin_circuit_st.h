...
struct origin_circuit_t {
  ...
  /* If this flag is set (due to delay negotiation failure), we should
   * not try to negotiate further circuit delays. */
  unsigned delay_negotiation_failed : 1;
...
#define PATHBIAS_SHOULDCOUNT_COUNTED   2
  ...
  /**
   * 21/12 track number of relay cells sent on this circuit mod 32. 
   * re-negotiate delays (i.e., send fresh samples to hop) whenever this value is 0.
   */
   uint8_t relay_cell_count;
